...
namespace DBapplication
{
    ...
    {
        static string DB_Connection_String = @"Data Source=DESKTOP-8NCC9GI\SQLEXPRESS;Initial Catalog=Cars_Dealership;Integrated Security=True;MultipleActiveResultSets=true";
